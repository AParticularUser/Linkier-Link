//poached these from the WuBor Patch
...
pub mod vars {
    // pub mod instance {//0x00??
    //     pub const FIGHTER_FLAG_LINK_ : i32 = 0x0000;
    // }
    pub mod status {//0x10??
        pub const FIGHTER_FLAG_LINK_FINISHING_BLOW_DEAD : i32 = 0x10FF;
    }
}